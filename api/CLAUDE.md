...
| Module path | `github.com/angelospanag/riffle` |
...
|---|---|---|---|
| `PORT` | no | `8080` | |
| `DATABASE_URL` | no | `postgres://postgres:postgres@localhost:5432/riffle_backend?sslmode=disable` | |
