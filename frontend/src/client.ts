...
const {query: queryOptions, axios: axiosOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetFeedsQueryKey();
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getFeeds>>, TError, TData> & { queryKey: QueryKey }
}
...
const {query: queryOptions, axios: axiosOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetFeedItemsQueryKey(feedID);
   ...
   return  { queryKey, queryFn, enabled: !!(feedID), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getFeedItems>>, TError, TData> & { queryKey: QueryKey }
}
...
const {query: queryOptions, axios: axiosOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetFeedItemQueryKey(feedID,itemID);
   ...
   return  { queryKey, queryFn, enabled: !!(feedID && itemID), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getFeedItem>>, TError, TData> & { queryKey: QueryKey }
}
